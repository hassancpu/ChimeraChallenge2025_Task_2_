...
class TransMIL(nn.Module):
    def __init__(self, n_classes=2, feat_type='uni'):
        ...
        self._fc2 = nn.Linear(size[1] + 30, n_classes)
    ...
    def forward(self, input, coords= None, clinic= None,):
        device = input.device # Nxfeat_dim 
        ...
        # ---->cls_token
        B = h.shape[0]
        cls_tokens = self.cls_token.expand(B, -1, -1).to(device)  # [B, 1, 256]
        ...
        return logits, Y_prob, Y_hat, A, _ 