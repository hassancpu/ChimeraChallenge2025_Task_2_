...
def main(args):
    ...
    print('\n Val:\n loss ± std: {0:.5f} ± {1:.3f}'.format(val_loss_ave, val_loss_std))
...
parser.add_argument('--model_type', type=str, choices=['max_pool', 'mean_pool', 'max_pool_ins', 'mean_pool_ins', 'abmil', 'gabmil', 'clam', 'transmil', 'madmil', 'rrtmil', 'wikg', 'x_cos', 'x_class', 'dsmil', 'acmil'], default='gabmil', help='type of model')
...
parser.add_argument('--n', type= int, default= 1, help='number of heads in the attention network')

### ACMIL specific options  
parser.add_argument("--n_token", type=int, default=5, help="number of attention branches in (MBA).")
